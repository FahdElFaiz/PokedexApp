package com.elfaiz.pokedexproject.Adapter;
...
import com.elfaiz.pokedexproject.Interface.IItemClickListener;
import com.elfaiz.pokedexproject.Model.Pokemon;
import com.elfaiz.pokedexproject.R;
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        holder.setiItemClickListener(new IItemClickListener() {
            ...
            public void onClick(View view, int position) {
               // Toast.makeText(context,"il y a eu un clique sur le pokemon: "+pokemonList.get(position).getName(),Toast.LENGTH_LONG).show();
